  ...
  if (array.length) {
    ...
    array.forEach((menuObject) => {
      ...
      <div class="card-body">
        ...
        <a href="#" id="edit-menuItem--${menuObject.firebaseKey}" class="btn btn-primary">Add to Order</a>
        <a href="#" id="delete-menuItem--${menuObject.firebaseKey}" class="btn btn-primary">Add to Order</a>
      </div>
    </div>`;
    });
    domString += '</div>';
